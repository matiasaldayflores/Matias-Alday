...
### mom-test + 100m-offers

Mom Test extracts the customer's actual language about their dream outcome. Use those exact words when designing the offer's value proposition.

| Mom Test Output | 100m-offers Input |
|-----------------|-------------------|
| "I lost 4 hours a week to manual reporting" | Time delay lever (reduce) |
| "I almost got fired last quarter" | Dream outcome (specific stakes) |
| "I pay a contractor $1500/mo for this" | Price anchor + total value math |
| 15 obstacles named in conversations | Step 2 obstacle list (no need to invent) |
...
|---------------|----------|------|
| Background | "Walk me through your week" | Situation |
| Pain | "What's the cost of doing nothing?" | Problem + Implication |
...
- Multiple people describe the same problem in similar words
- You can predict the next interview's answers
- People are paying you (deposits, LOIs, real money)
